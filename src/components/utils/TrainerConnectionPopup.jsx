                ...
                <section className='flex items-center mt-2 justify-between relative'>
                    ...
                    <div className='flex gap-3 justify-center items-center'>
                        ...
                        {openOptionsConversationId === c?._id && (
                            <div ref={wrapperRef} className="fixed bg-gray-200 rounded-lg z-5000 ml-56 mt-10 ">
                        ...
                        <div className='connectionScroll overflow-y-scroll max-h-[90vh]'>
                            {
                                connections?.length > 0 ?
                                    connections?.map((c, index) => <ConversationCard key={index} c={c} id={props?.id} />)
                                    :
                        ...
                        <div className='connectionScroll overflow-y-scroll max-h-[90vh]'>
                            {
                                conversationRequest?.length > 0 ?
                                    conversationRequest?.map((c, index) => <NewRequestCard key={index} c={c} id={props?.id} />)
                                    :
                                    <div className='w-full flex justify-center items-center h-[200px]'>
                                        <span className='text-gray-500'>No requests available</span>
                                    </div>
                            }
                        </div>
                    )}
